    ...
    public class Pacote : Entidade
    {
        ...
        public Pacote(string titulo, string descricao, string imagem, bool ativo)
        {
            AddNotifications(new Contract()
                ...
                .IsNotNullOrEmpty(descricao, "Descricao", " Informe a descrição")
                .IsNotNullOrEmpty(imagem, "Imagem", "Informe a imagem")
            );
        ...
        public void AdicionarComentario(Comentario comentario)
        {
            if (_comentarios.Any(x => x.IdUsuario == comentario.IdUsuario))
                AddNotification("Comentarios", "Usuário já possui um comentario no pacote");
